...
{% macro _get_sql(path) %}
  ...
  {% elif target.type == 'sqlserver' %}
    {% if path == 'baseline/shop_schema' %}
      {{ return(origin_simulator_ops._get_sqlserver_baseline_shop_schema()) }}
    {# Baseline shop - table-specific #}
    {% elif path == 'baseline/shop_customers' %}
      {{ return(origin_simulator_ops._get_sqlserver_baseline_shop_customers()) }}
    {% elif path == 'baseline/shop_products' %}
      {{ return(origin_simulator_ops._get_sqlserver_baseline_shop_products()) }}
    {% elif path == 'baseline/shop_orders' %}
      {{ return(origin_simulator_ops._get_sqlserver_baseline_shop_orders()) }}
    {% elif path == 'baseline/shop_order_items' %}
      {{ return(origin_simulator_ops._get_sqlserver_baseline_shop_order_items()) }}
    {% elif path == 'baseline/crm_schema' %}
      {{ return(origin_simulator_ops._get_sqlserver_baseline_crm_schema()) }}
    {# Baseline CRM - table-specific #}
    {% elif path == 'baseline/crm_campaigns' %}
      {{ return(origin_simulator_ops._get_sqlserver_baseline_crm_campaigns()) }}
    {% elif path == 'baseline/crm_email_activity' %}
      {{ return(origin_simulator_ops._get_sqlserver_baseline_crm_email_activity()) }}
    {% elif path == 'baseline/crm_web_sessions' %}
      {{ return(origin_simulator_ops._get_sqlserver_baseline_crm_web_sessions()) }}
    {% elif path == 'utilities/truncate_shop' %}
      {{ return(origin_simulator_ops._get_sqlserver_utilities_truncate_shop()) }}
    {% elif path == 'utilities/truncate_crm' %}
      {{ return(origin_simulator_ops._get_sqlserver_utilities_truncate_crm()) }}
    {# Delta table-specific routes #}
    {% elif path == 'deltas/day_01_crm_email_activity' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_01_crm_email_activity()) }}
    {% elif path == 'deltas/day_01_crm_web_sessions' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_01_crm_web_sessions()) }}
    {% elif path == 'deltas/day_01_shop_customers' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_01_shop_customers()) }}
    {% elif path == 'deltas/day_01_shop_order_items' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_01_shop_order_items()) }}
    {% elif path == 'deltas/day_01_shop_orders' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_01_shop_orders()) }}
    {% elif path == 'deltas/day_01_shop_orders_updates' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_01_shop_orders_updates()) }}
    {% elif path == 'deltas/day_01_shop_payments' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_01_shop_payments()) }}
    {% elif path == 'deltas/day_02_crm_email_activity' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_02_crm_email_activity()) }}
    {% elif path == 'deltas/day_02_crm_web_sessions' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_02_crm_web_sessions()) }}
    {% elif path == 'deltas/day_02_shop_customers' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_02_shop_customers()) }}
    {% elif path == 'deltas/day_02_shop_order_items' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_02_shop_order_items()) }}
    {% elif path == 'deltas/day_02_shop_orders' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_02_shop_orders()) }}
    {% elif path == 'deltas/day_02_shop_orders_updates' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_02_shop_orders_updates()) }}
    {% elif path == 'deltas/day_02_shop_payments' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_02_shop_payments()) }}
    {% elif path == 'deltas/day_02_shop_products_updates' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_02_shop_products_updates()) }}
    {% elif path == 'deltas/day_03_crm_email_activity' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_03_crm_email_activity()) }}
    {% elif path == 'deltas/day_03_crm_web_sessions' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_03_crm_web_sessions()) }}
    {% elif path == 'deltas/day_03_shop_customers' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_03_shop_customers()) }}
    {% elif path == 'deltas/day_03_shop_order_items' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_03_shop_order_items()) }}
    {% elif path == 'deltas/day_03_shop_orders' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_03_shop_orders()) }}
    {% elif path == 'deltas/day_03_shop_orders_updates' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_03_shop_orders_updates()) }}
    {% elif path == 'deltas/day_03_shop_payments' %}
      {{ return(origin_simulator_ops._get_sqlserver_deltas_day_03_shop_payments()) }}
    {% else %}
